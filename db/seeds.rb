...
u1 = User.create(name: "Name1", username: "Username1", email: "username1@gmail.com", status: "default status")
u2 = User.create(name: "Name2", username: "Username2", email: "username2@gmail.com", status: "default status")
u3 = User.create(name: "Name3", username: "Username3", email: "username3@gmail.com", status: "default status")
u4 = User.create(name: "Name4", username: "Username4", email: "username4@gmail.com", status: "default status")
u5 = User.create(name: "Name5", username: "Username5", email: "username5@gmail.com", status: "default status")
u6 = User.create(name: "Name6", username: "Username6", email: "username6@gmail.com", status: "default status")
